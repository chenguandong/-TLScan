...
import com.king.zxing.tl.TLScanActivity;
...
public class MainActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public void onClick(View v){
        ...
        switch (v.getId()){
            ...
            case R.id.btn7:
                ...
                break;
            case R.id.btn8:
               // startActivity(new Intent(MainActivity.this, TLScanActivity.class));
                //跳转的默认扫码界面
                startActivityForResult(new Intent(MainActivity.this,TLScanActivity.class),TLScanActivity.REQUEST_CODE_SCAN);
                break;
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode == RESULT_OK && data!=null){
            switch (requestCode){
                case TLScanActivity.REQUEST_CODE_SCAN:
